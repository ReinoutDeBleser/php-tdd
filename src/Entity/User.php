...
class User
{
    ...
    #[ORM\OneToMany(mappedBy: 'userRelation', targetEntity: Bookings::class)]
    private $bookings;
    ...
    public function removeBooking(Bookings $booking): self
    {
        if ($this->bookings->removeElement($booking)) {
            ...
            if ($booking->getUserRelation() === $this) {
                $booking->setUserRelation(null);
            }
        }
