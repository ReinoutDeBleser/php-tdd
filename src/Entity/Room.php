...
class Room
{
    ...
    #[ORM\OneToMany(mappedBy: 'roomrelation', targetEntity: Bookings::class)]
    private $bookings;
    ...
    public function removeBooking(Bookings $booking): self
    {
        if ($this->bookings->removeElement($booking)) {
            ...
            if ($booking->getRoomrelation() === $this) {
                $booking->setRoomrelation(null);
            }
        }
